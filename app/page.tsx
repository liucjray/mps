...
import { facebookUrl, googleMapsSearchUrl, heroImageUrl, instagramUrl, introImageUrl, knowledgeImageUrl, knowledgeIndexPath, lineUrl, organizationId, phoneNumber, sharedOrganizationEntity, sharedServedAreas, siteAddressLine, siteBusinessHours, siteCanonicalUrl, siteDescription, siteEmail, siteLastModified, siteName, siteServiceArea, siteTransitInfo, siteUrl, stretchMarksKnowledgePath, striaeKnowledgePath } from "./site";
  ...
  return (
    <>
      ...
      <section className="knowledge section-shell">
        <div className="knowledge-copy"><div className="section-label nav-target" id="knowledge">雙和店肌膚知識</div><h2>把專業，<br /><em>說得更容易懂。</em></h2><p>從紋路形成、孕期與產後照護，到膚色判斷與外觀修飾，雙和店把常見問題整理成容易閱讀的肌膚知識。先看懂，再決定要不要開始。</p><p className="content-note">本站提供一般肌膚美學資訊，不取代醫療診斷或治療建議。</p><div className="knowledge-links"><a className="text-link" href={knowledgeIndexPath} data-ga-event="content_navigation" data-ga-cta-location="knowledge_section">前往雙和店肌膚知識中心 <span aria-hidden="true">↗</span></a><a className="text-link" href={stretchMarksKnowledgePath} data-ga-event="content_navigation" data-ga-cta-location="knowledge_section">閱讀妊娠紋知識指南 <span aria-hidden="true">↗</span></a><a className="text-link" href={striaeKnowledgePath} data-ga-event="content_navigation" data-ga-cta-location="knowledge_section">閱讀肥胖紋與生長紋比對 <span aria-hidden="true">↗</span></a><a className="text-link" href={darkCirclesPath} data-ga-event="content_navigation" data-ga-cta-location="knowledge_section">閱讀黑眼圈知識 <span aria-hidden="true">↗</span></a><a className="text-link" href={facebookUrl} target="_blank" rel="noreferrer" data-ga-event="contact_click" data-ga-contact-method="facebook" data-ga-cta-location="knowledge_section">前往雙和店 Facebook <span aria-hidden="true">↗</span></a></div></div>
        <div className="knowledge-card"><div className="knowledge-photo"><img src={knowledgeImage} alt="肌膚教育與科技測色使用的膚色色彩樣本與保養瓶" width={1448} height={1086} loading="lazy" decoding="async" /></div><div className="knowledge-topics"><span className="knowledge-card-label">TOPICS WE COVER</span><div className="topic-list"><a href={stretchMarksKnowledgePath} data-ga-event="content_navigation" data-ga-cta-location="knowledge_topics">妊娠紋</a><a href={striaeKnowledgePath} data-ga-event="content_navigation" data-ga-cta-location="knowledge_topics">肥胖紋</a><a href={striaeKnowledgePath} data-ga-event="content_navigation" data-ga-cta-location="knowledge_topics">成長紋</a><span>各類疤痕</span><span>草本撫紋</span><span>科技測色</span><a href={darkCirclesPath} data-ga-event="content_navigation" data-ga-cta-location="knowledge_topics">黑眼圈</a><span>輪廓美學</span></div></div><span className="knowledge-card-note">雙和店 / professional skin education</span></div>
      </section>
