...
import { facebookUrl, instagramUrl, lineUrl, phoneNumber, siteCanonicalUrl, siteDescription, siteLastModified, siteName, siteUrl, socialImageUrl } from "../../site";
  ...
  return (
    <>
      ...
      <main id="main-content">
        ...
        <section className="contact service-detail-contact section-shell" id="contact" aria-labelledby="service-contact-title"><div className="contact-copy"><div className="section-label">新北市中和區・雙和店</div><h2 id="service-contact-title">想了解這項服務，<br /><em>可以從這裡開始。</em></h2><p>歡迎透過雙和店 Facebook 私訊，或直接致電 0981-756-111，先聊聊你的狀況。</p></div><div className="contact-actions"><a className="contact-button" href={facebookUrl} target="_blank" rel="noreferrer"><span>前往雙和店 Facebook<br /><small>了解最新案例與預約方式</small></span></a><a className="contact-secondary" href={`tel:${phoneNumber}`}>電話諮詢 0981-756-111</a><a className="contact-secondary" href={instagramUrl} target="_blank" rel="noreferrer">Instagram @mavis_pure_skin</a><a className="contact-secondary" href={lineUrl} target="_blank" rel="noreferrer">LINE 官方帳號</a></div></section>
      </main>
